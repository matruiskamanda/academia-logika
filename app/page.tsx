      ...
      <section className="bg-linear-to-br from-blue-600 via-purple-600 to-indigo-700 text-white py-24 px-6 text-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-xl mb-10 max-w-3xl mx-auto leading-relaxed">
            ...
            confianza. Clases personalizadas de Español y Matemáticas, desde
            nivel básico hasta preparatoria.
          </p>
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="bg-white p-10 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300">
            ...
            <p className="text-lg text-gray-700">
              Tablas, operaciones, fracciones, geometría, problemas y
              razonamiento lógico
            </p>
          </div>
          <div className="bg-white p-10 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Comparte tu experiencia con Academia Lógika..."
              ></textarea>
            </div>
            <button
              type="submit"
